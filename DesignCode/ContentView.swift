...
//  DesignCode
//
//  Created by Yohan on 2023-08-19.
//
...
struct ContentView: View {
    ...
    @State var viewState = CGSize.zero // X and Y positions
    ...
    var body: some View {
        VStack(spacing: 20){
            Rectangle()
                ...
                .cornerRadius(3)
                .opacity(0.1)
            Text("This certificate is proof is that Meng to has achieved the UI Design course with approval from a Design+Code instructor.")
                .multilineTextAlignment(.center)
                .font(.subheadline)
                .lineSpacing(4)
            
            HStack(spacing: 20.0) {
                RingView(color1: Color.blue, color2: Color.red, width: 88, height: 88, percent: 78, show: $show)
